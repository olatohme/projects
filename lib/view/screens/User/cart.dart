          ...
          child: Container(
            ...
            child: Column(
              ...
              children :[
                ...
                //   child: TextUtils(text: "user name: "+"${controller.cartlist.userName}",color: Colors.black,fontSize: 18,
                //     fontWeight: FontWeight.w100,underLine:  TextDecoration.none,
                //     fontfamily: 'OleoScript',),
                // ),
                Row(
                    children:
                    [
                      ...
                      child:TextButton(
                        child: TextUtils(text: "your items",
                        color: darkbeige,
                        fontSize: 22,
                 ...
                 TextButton(
                   ...
                   child:TextUtils(text: "your bouquets",
                        color: darkbeige,
                        fontSize: 22,
                        fontWeight: FontWeight.w100,
                        underLine: TextDecoration.none,
                ...
                // Padding(
                //   padding: const EdgeInsets.all(0.0),
                //   child: TextUtils(text: "your items",color: darkbeige,fontSize: 22,
                //     fontWeight: FontWeight.w100,underLine:  TextDecoration.none,
                //     fontfamily: 'OleoScript',),
                // ),
                SizedBox(height: 12,),
                ...
                child:  Obx(() {
                  if (check == 'items') {
                    if (controller.isloading.isTrue) {
                      ...
                      return
                        controller.cartlist.items.length==0?
                  ...
                  // Padding(
                  //   padding: const EdgeInsets.all(0.0),
                  //   child: TextUtils(text: "your bouquets ",/*"${controller.cartlist.collections[index].name}"*/color:darkbeige,fontSize: 22,
                  //     fontWeight: FontWeight.w100,underLine:  TextDecoration.none,
                  //     fontfamily: 'OleoScript',),
                  // ),
                    ...
                    .width,
                        ...
                        Obx(() {
                          if (controller.isloading.isTrue) {
                            ...
                            return
                            controller.cartlist.customBouquets
                                      .length==0?
                        Center(child: Column(children: [
                          SizedBox(height: 200,),
                        Container(
