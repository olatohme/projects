...
import 'package:new_proj/controller/profile_update_provider_controller.dart';
...
class ProfileUPdatePro extends StatelessWidget {
  ProfileUPdatePro({Key? key}) : super(key: key);
  final controller = Get.find<ProfileUpdateProvider_Controller>();
  var controllerprovider= Get.find<ProfileProviderController>();
                  ...
                  children: [
                    ...
                    Stack(children: [
                      ...
                      Container(
                        ...
                        child: Obx(() {
                          if (controller.profile_image == null &&
                            ...
                            return CircleAvatar(
                                ...
                                backgroundImage: FileImage(controller.profile_image!) // المسار لصورتك
                            );
                          // Image.file(
                          //   controller.image!,
                          //   fit: BoxFit.cover,
                            ...
                            child: Basic_Button(text: 'Update',
                              ...
                              onPressed: ()async{
                                if (fromKey.currentState!.validate()) {
                                  ...
                                  await controller.ProfileUpdateprovider();
                                  Get.back();
                                  controllerprovider.fetchProfileProvider();
                                 // Get.offNamed('/');
                                }
                              },),
                          ),
